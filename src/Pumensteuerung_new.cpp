...
**************************/
void PUMPENSTEUERUNG::setup_pumpensteuerung()
{
...
************************/
char* PUMPENSTEUERUNG::loop_pumpensteuerung()
{
...
void PUMPENSTEUERUNG::print_to(int to, const __FlashStringHelper *s) {
    if(to==1){
        sms.print(s);
    }
    if(to==2){
